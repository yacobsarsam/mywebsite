...
public class ProjectsDataSeeder {
    ...
    public List<Project> GetProjectsAsList() throws MalformedURLException {
        Project p0 = new Project("Webshop applikation (länk till källkod: https://github.com/yacobsarsam/webshop-backend, https://github.com/yacobsarsam/webshop-frontend)",
